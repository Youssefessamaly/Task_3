...
export default function AllPerks() {
  ...
  // Effect #1: Initial Data Load (runs once when component mounts)
  useEffect(() => {
    loadAllPerks()
  }, [])

  // Effect #2: Auto-search whenever search or filter changes
  useEffect(() => {
    ...
    // Cleanup old timers if user keeps typing
    return () => clearTimeout(delay)
  }, [searchQuery, merchantFilter])

  // Effect #3: Extract unique merchants when perks change
  useEffect(() => {
